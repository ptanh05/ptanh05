...
function generateMetricsSvg(data) {
  ...
  <g transform="translate(24, 48)">
    ...
    <g transform="translate(218, 0)">
      <rect x="0" y="0" width="102" height="64" rx="6" fill="#f8fafc" stroke="#e2e8f0" stroke-width="1" />
      <text x="12" y="20" fill="#64748b" font-size="8.5" font-weight="600" class="font-sans">CONTRIBUTIONS</text>
      <text x="12" y="47" fill="#0f172a" font-size="22" font-weight="800" class="font-sans">1.3k+<tspan fill="#10b981" font-size="9" font-weight="600" dx="4" dy="-2">commits</tspan></text>
    </g>
